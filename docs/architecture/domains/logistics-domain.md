...
> **Hub de Domínio:** [logistics-domain](logistics-domain.md) | [system-overview](../concepts/system-overview.md)
...
- **Modelos de Dados:**
  - [supplier-model](../../reference/models/logistics/supplier-model.md): Cadastro de fornecedores com validação de CNPJ.
  - [contract-model](../../reference/models/logistics/contract-model.md): Contratos com suporte a PDF e hierarquia de aditivos.
  - [item-model](../../reference/models/logistics/item-model.md): Itens contratados por evento.
...
- **Subcomponentes e Dialogs:**
  ...
  - `ContractUploadDialog.tsx` — Modal avançado de upload de contrato PDF para Cloudflare R2 com geração de despesas e itens. Veja [contract-pdf-upload-r2-flow](../concepts/contract-pdf-upload-r2-flow.md).
...
- [contract-pdf-upload-r2-flow](../concepts/contract-pdf-upload-r2-flow.md): Fluxo de upload de contratos em PDF via Cloudflare R2.
