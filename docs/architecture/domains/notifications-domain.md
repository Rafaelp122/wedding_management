...
> **Módulo:** [system-overview](../concepts/system-overview.md) | [in-app-notifications-rules](../business-rules/notifications/in-app-notifications-rules.md)
...
- **Modelo de Dados:** [notification-model](../../reference/models/notifications/notification-model.md)
- **Regras de Negócio:** [in-app-notifications-rules](../business-rules/notifications/in-app-notifications-rules.md)
- **Fluxo de CI/CD & Async:** [ci-cd-pipeline-flow](../concepts/ci-cd-pipeline-flow.md)
