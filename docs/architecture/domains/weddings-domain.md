...
> **Hub de Domínio:** [weddings-domain](weddings-domain.md) | [system-overview](../concepts/system-overview.md)
...
- **Modelo de Dados:** [wedding-model](../../reference/models/weddings/wedding-model.md) — Entidade `Wedding`.
