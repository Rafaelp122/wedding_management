...
> **Hub de Domínio:** [dashboard-domain](dashboard-domain.md) | [system-overview](../concepts/system-overview.md)
...
- **Endpoints (`api.py`):** GET `/api/v1/dashboard/summary/` e GET `/api/v1/dashboard/wedding/{uuid}/`. Veja [openapi-schema](../../reference/api/openapi-schema.md).
