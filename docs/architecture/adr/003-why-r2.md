...
> **Data:** Janeiro 2025
> **Decisor:** Rafael
> **Relacionados:** [ADR-004: Presigned URLs](004-presigned-urls.md) · [ADR-020: StorageService Abstraction](020-storage-service-abstraction.md) · [ADR-025: Terraform & GitOps](025-terraform-iac-architecture.md)
...
**:material-close-circle: CDN Separado (Cloudflare):**

- R2 não tem CDN integrado (S3 tem CloudFront)
- **Mitigação:** Cloudflare Workers (se necessário)

**:material-close-circle: Menos Mature que S3:**
