...
> **Data:** Fevereiro 2026
> **Decisor:** Rafael
> **Relacionados:** [ADR-012: Contract-Driven Frontend com Orval](012-orval-contract-driven-frontend.md) · [ADR-024: Padrão Smart/Dumb Components](024-padrao-smart-dumb-desacoplamento-componentes-frontend.md)
...
5. **Restrições de Execução em PRs:**
   ...
   - **Push na Branch Principal (`main`):** Executamos o conjunto completo de testes de fumaça e testes críticos de regressão para assegurar a estabilidade pré-deploy.
...
- **Tempo de pipeline adicional:** Mitigado pelo sharding paralelo em 2 vias e foco exclusivo em Chromium no CI.
- **Manutenção de dados de teste:** Exige manter o comando `seed_db` sincronizado com os modelos e regras de negócio vigentes.
...
2. [ADR-024: Padrão Smart/Dumb Components](024-padrao-smart-dumb-desacoplamento-componentes-frontend.md)
