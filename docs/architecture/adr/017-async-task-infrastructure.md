...
> **Data:** Fevereiro 2026
> **Decisor:** Rafael
> **Relacionados:** [ADR-001: Cloud Run para Hospedagem Serverless](001-why-cloud-run.md) · [ADR-005: Cloud Scheduler + OIDC para Tarefas Agendadas](005-oidc-scheduler.md)
...
- Necessidade de manter o token OIDC validado no endpoint de cron diário em produção (mitigado por middleware/decorator centralizado de autenticação OIDC).

---

## 4. Referências

1. [ADR-001: Cloud Run para Hospedagem Serverless](001-why-cloud-run.md)
2. [ADR-005: Cloud Scheduler + OIDC para Tarefas Agendadas](005-oidc-scheduler.md)
