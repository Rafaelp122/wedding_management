...
1. Adotar formalmente o guia [COMMENTING_STANDARDS.md](../../reference/architecture-standards/commenting-standards.md) como a especificação única de escrita de documentação do Wedding Management System.
