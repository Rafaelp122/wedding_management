...
> **Relacionados:** [ADR-025](../../4-explanation/adr/025-terraform-iac-architecture.md) | [ADR-027](../../4-explanation/adr/027-terraform-state-topology.md) | [terraform-index](../../3-reference/terraform/index.md) | [ci-cd-pipeline-flow](../../4-explanation/architecture/ci-cd-pipeline-flow.md)
