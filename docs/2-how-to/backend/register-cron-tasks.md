...
Este guia prático explica como criar e registrar rotinas de manutenção no sistema de agendamento em lote (**Daily Batch Cron**), conforme a [ADR-017](../../4-explanation/adr/017-async-task-infrastructure.md) e [ADR-005](../../4-explanation/adr/005-oidc-scheduler.md).
