...
> **Módulo:** [query-selectors-spec](../../3-reference/architecture-standards/query-selectors-spec.md) | [query-selectors-pattern](../../4-explanation/architecture/query-selectors-pattern.md)
