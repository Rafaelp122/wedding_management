...
> **Categoria:** How-To Guide (`2-how-to/documentation`)
> **Relacionados:** [documentation-standards](../../3-reference/architecture-standards/documentation-standards.md) | [make check-docs](../../3-reference/architecture-standards/documentation-standards.md#5-validação-automatizada-de-links-make-check-docs)
...
|:---|:---|:---|
| Ensinar um fluxo completo para um iniciante (onboarding) | **1. Tutorials** | `docs/1-tutorials/` |
| Fornecer uma receita prática passo a passo para resolver uma tarefa | **2. How-To** | `docs/2-how-to/<categoria>/` |
| Especificar um modelo de banco, contrato de API ou padrão técnico | **3. Reference** | `docs/3-reference/<categoria>/` |
| Explicar o raciocínio de design, arquitetura ou regra de negócio | **4. Explanation** | `docs/4-explanation/<categoria>/` |
...
A validação de links da documentação é explicada em [documentation-standards](../../3-reference/architecture-standards/documentation-standards.md).
```

---

## Passo 4: Atualizar os Índices (MOC e `docs/README.md`)
...
2. Registre a nova nota na seção correspondente do [docs/README.md](../../README.md).
