...
> **Módulo:** [terraform](index.md) | [ADR-025](../../4-explanation/adr/025-terraform-iac-architecture.md)
...
- `google_secret_manager_secret.email_smtp_user`: Container do segredo do usuário SMTP (`prevent_destroy = true`).
...
- `google_secret_manager_secret_iam_member.email_smtp_user_access`: Permissão `roles/secretmanager.secretAccessor` para deployer e runtime SA.
