...
> **Explicação:** [query-selectors-pattern](../../4-explanation/architecture/query-selectors-pattern.md) | [service-layer-pattern](../../4-explanation/architecture/service-layer-pattern.md)
