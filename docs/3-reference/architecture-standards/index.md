# Padrões Arquiteturais de Código e Documentação

Especificações técnicas de documentação, comentários, docstrings, commits, módulos IaC e serviços de infraestrutura.
...
- [../terraform/index.md](../terraform/index.md) — MOC e especificações técnicas de módulos IaC (Terraform)
- [infrastructure-services.md](infrastructure-services.md) — Serviços de infraestrutura e deployment
