...
> **Módulo:** [architecture-standards](index.md) | [docs-readme](../../README.md)
...
- Pastas que agrupam múltiplas notas atômicas (ex: `docs/3-reference/models/`, `docs/3-reference/testing/`, `docs/4-explanation/business-rules/`) devem conter um arquivo `index.md` atuando como **MOC (Map of Content)**.
...
|:---|:---|:---|:---|
| **1. Tutorials** | `docs/1-tutorials/` | Aprendizado & Onboarding | Guias passo a passo guiados para iniciantes no projeto (ex: subir ambiente local). |
| **2. How-To Guides** | `docs/2-how-to/` | Resolução de Problemas | Receitas práticas e orientadas a tarefas do dia a dia (ex: como gerar cliente Orval). |
| **3. Reference** | `docs/3-reference/` | Especificação Técnica | Descrições técnicas puras, schemas de banco, contratos de API e padrões. |
| **4. Explanation** | `docs/4-explanation/` | Compreensão e Arquitetura | Contexto profundo de design, regras de negócio atômicas e ADRs. |
