# Especificações Técnicas de Módulos Terraform (MOC)

> **Módulo:** [architecture-standards](../architecture-standards/index.md) | [ci-cd-pipeline-flow](../../architecture/concepts/ci-cd-pipeline-flow.md)
