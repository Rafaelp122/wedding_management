...
> **Módulo:** [architecture-standards](../architecture-standards/index.md) | [system-overview](../../architecture/concepts/system-overview.md) | [ci-cd-pipeline-flow](../../architecture/concepts/ci-cd-pipeline-flow.md)
...
## Operational Skills (Playbooks On-Demand)
