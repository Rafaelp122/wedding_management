...
- **Ambiente & Doc:** [setup-local-environment](2-how-to/dev-environment/setup-local-environment.md) | [database-migrations](2-how-to/dev-environment/database-migrations.md) | [write-and-update-docs](2-how-to/documentation/write-and-update-docs.md)
...
- **Padrões Técnicos:** [documentation-standards](3-reference/architecture-standards/documentation-standards.md) | [query-selectors-spec](3-reference/architecture-standards/query-selectors-spec.md) | [commenting-standards](3-reference/architecture-standards/commenting-standards.md) | [commit-convention-spec](3-reference/architecture-standards/commit-convention-spec.md) | [testing-index](3-reference/testing/index.md) ([backend](3-reference/testing/backend-testing-spec.md) | [frontend](3-reference/testing/frontend-testing-spec.md) | [e2e](3-reference/testing/e2e-testing-spec.md) | [terraform](3-reference/testing/terraform-testing-spec.md)) | [ci-cd-index](3-reference/ci-cd/index.md) | [terraform-index](3-reference/terraform/index.md) | [guard-rails-index](3-reference/architecture-standards/guard-rails/index.md) | [infrastructure-services](3-reference/architecture-standards/infrastructure-services.md)
...
- **Entidades de Banco (Models):**
  ...
  - [tenant-model](3-reference/models/tenants/tenant-model.md) | [user-model](3-reference/models/users/user-model.md) | [wedding-model](3-reference/models/weddings/wedding-model.md) | [notification-model](3-reference/models/notifications/notification-model.md)
...
- **Visões de Arquitetura & Requisitos:**
  ...
  - [query-selectors-pattern](4-explanation/architecture/query-selectors-pattern.md) — Padrão Query Selectors & Custom QuerySets.
...
- **Hubs de Domínio Fullstack (MOCs):**
  - [core-domain](4-explanation/domains/core-domain.md) | [dashboard-domain](4-explanation/domains/dashboard-domain.md) | [reporting-domain](4-explanation/domains/reporting-domain.md) | [finances-domain](4-explanation/domains/finances-domain.md) | [logistics-domain](4-explanation/domains/logistics-domain.md) | [scheduler-domain](4-explanation/domains/scheduler-domain.md) | [tenants-domain](4-explanation/domains/tenants-domain.md) | [users-domain](4-explanation/domains/users-domain.md) | [weddings-domain](4-explanation/domains/weddings-domain.md) | [notifications-domain](4-explanation/domains/notifications-domain.md)
- **Regras de Negócio Atômicas:**
  - [installment-overdue-logic](4-explanation/business-rules/finances/installment-overdue-logic.md) | [financial-integrity-rules](4-explanation/business-rules/finances/financial-integrity-rules.md) | [payment-schedule-integration](4-explanation/business-rules/finances/payment-schedule-integration.md) | [budget-category-distribution](4-explanation/business-rules/finances/budget-category-distribution.md) | [in-app-notifications-rules](4-explanation/business-rules/notifications/in-app-notifications-rules.md)
