...
| **Guia Prático** | [register-cron-tasks](../../2-how-to/backend/register-cron-tasks.md) | [create-background-tasks](../../2-how-to/backend/create-background-tasks.md) |
...
- **Guia How-To Crons:** [register-cron-tasks](../../2-how-to/backend/register-cron-tasks.md)
- **Guia How-To Async Tasks:** [create-background-tasks](../../2-how-to/backend/create-background-tasks.md)
