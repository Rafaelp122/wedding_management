...
1. Adotar formalmente o guia [COMMENTING_STANDARDS.md](../../3-reference/architecture-standards/commenting-standards.md) como a especificação única de escrita de documentação do Wedding Management System.
