...
> **Hub de Domínio:** [finances-domain](finances-domain.md) | [system-overview](../architecture/system-overview.md)
...
- **Modelos de Dados:**
  - [budget-model](../../3-reference/models/finances/budget-model.md): Orçamento global do casamento.
  - [budget-category-model](../../3-reference/models/finances/budget-category-model.md): Alocação por categorias (Buffet, Decoração, etc.).
  - [expense-model](../../3-reference/models/finances/expense-model.md): Compromisso financeiro ou contrato.
  - [installment-model](../../3-reference/models/finances/installment-model.md): Parcelamento de pagamentos com datas de vencimento.
- **Service Layer:** `budget_service.py`, `expense_service.py`, `installment_service.py`. Veja [service-layer-pattern](../architecture/service-layer-pattern.md).
