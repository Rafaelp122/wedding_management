...
> **Hub de Domínio:** [users-domain](users-domain.md) | [system-overview](../architecture/system-overview.md)
...
- **Modelo de Dados:** [user-model](../../3-reference/models/users/user-model.md) — Custom User Model com `email` como `USERNAME_FIELD` e `CustomUserManager`.
- **Service Layer:**
...
- **Arquitetura de Autenticação:** [auth-jwt-flow](../architecture/auth-jwt-flow.md).
