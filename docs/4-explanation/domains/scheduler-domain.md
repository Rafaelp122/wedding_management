...
> **Hub de Domínio:** [scheduler-domain](scheduler-domain.md) | [system-overview](../architecture/system-overview.md)
...
- **Modelos de Dados:**
  - [event-model](../../3-reference/models/scheduler/event-model.md): Compromissos e marcos na agenda.
  - [task-model](../../3-reference/models/scheduler/task-model.md): Itens do checklist operacional.
