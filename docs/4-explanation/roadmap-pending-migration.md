...
> [!WARNING]
> **NOTA DE MIGRAÇÃO TEMPORÁRIA:** Este documento representa o roadmap interno legado do projeto e está mantido nesta nota temporária até que todas as tarefas e epics sejam totalmente migrados para o gerenciador de tarefas/issues externo (ex: GitHub Issues / Jira).
...
- [Casos de Uso](architecture/system-overview.md)
- [Requisitos Funcionais](architecture/system-overview.md)
- [Regras de Negócio](domains/core-domain.md)
- [Arquitetura](architecture/system-overview.md)
