...
export default function BudgetSimulator() {
  ...
  useEffect(() => {
    ...
    if (style === 'campo') {
      ...
      styleTasks = [
        { title: 'Mapeamento de backup contra chuva na Fazenda Vila Rica', tag: 'Fase 1 • Plano B' },
        { title: 'Dimensionamento de gerador sobressalente para luz decorativa', tag: 'Fase 1 • Carga' },
        { title: 'Sinalização de acesso rodoviário para fornecedores', tag: 'Fase 1 • Acesso' }
      ];
    } else if (style === 'classico') {
      costPerGuest = 750;
      title = 'Clássico Sofisticado';
      styleTasks = [
        { title: 'Aprovação do layout de iluminação cenográfica clássica', tag: 'Fase 1 • Design' },
        { title: 'Reserva de espaço fechado com proteção termoacústica', tag: 'Fase 1 • Espaço' },
        { title: 'Alinhamento com coral clássico e músicos de entrada', tag: 'Fase 1 • Protocolo' }
      ];
    } else {
      // Praia
      styleTasks = [
        { title: 'Verificar autorização da Capitania dos Portos para cerimônia na areia', tag: 'Fase 1 • Licença' },
        { title: 'Definir plano B de lona ou espaço coberto contra brisa e maré', tag: 'Fase 1 • Logística' },
        { title: 'Definição do menu Fasano com opções de frutos do mar frescos', tag: 'Fase 1 • Menu' }
      ];
    }
  ...
  const spaceAlloc = budget * 0.30;
  const buffetAlloc = budget * 0.40;
  const decoAlloc = budget * 0.30;
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div className="lg:col-span-5 space-y-6 text-left">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2" htmlFor="simGuests">
            ...
            >
              ...
              <option value="200">Casamento Médio (100 a 200 convidados)</option>
              <option value="350">Grande Casamento (Mais de 300 convidados)</option>
            </select>
          </div>
        ...
        <div className="bg-white dark:bg-surface-darkSecondary rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-2xl p-6 space-y-6 relative overflow-hidden text-left">
          ...
          <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-display font-bold text-sm text-zinc-950 dark:text-white">Estimativa Financeira do Casamento</h3>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#FBFBFE] dark:bg-zinc-900/40 p-4 rounded-xl border border-zinc-200/60 dark:border-zinc-800/80">
              <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block">Orçamento Ideal Estimado</span>
              <span className="font-mono text-xl font-bold text-zinc-950 dark:text-white mt-1 block">
                {formatBRL(budget)}
              </span>
            </div>
            <div className="bg-[#FBFBFE] dark:bg-zinc-900/40 p-4 rounded-xl border border-zinc-200/60 dark:border-zinc-800/80">
              <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-wider block">Estilo Recomendado</span>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="space-y-1">
                ...
                <div className="w-full bg-zinc-100 dark:bg-zinc-800 rounded-full h-1 overflow-hidden">
                  <div className="bg-[#7C3AED] h-1 rounded-full animate-progress" style={{ width: '30%' }}></div>
                </div>
              </div>
              {/* Category 2 */}
              <div className="space-y-1">
                ...
                <div className="w-full bg-zinc-100 dark:bg-zinc-800 rounded-full h-1 overflow-hidden">
                  <div className="bg-[#7C3AED] h-1 rounded-full animate-progress" style={{ width: '40%' }}></div>
                </div>
              </div>
              {/* Category 3 */}
              <div className="space-y-1">
          ...
          <div className="space-y-2">
            <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Primeiras Tarefas Ativadas pelo Template</h4>
            <div className="space-y-2">
              {tasks.map((task, index) => (
                ...
                >
                  <div className="flex items-start gap-2.5 pr-2 text-left">
                    ...
                    <span className="leading-tight"><span className="sr-only">(Pendente) </span>{task.title}</span>
                  </div>
