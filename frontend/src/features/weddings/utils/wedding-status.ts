...
/**
 * Retorna as informacoes do status do casamento (label e variante do badge).
 */
...
/**
 * Retorna o rotulo legivel (label) associado ao status do casamento.
 */
...
/**
 * Retorna o estilo CSS (classes do Tailwind e icone/indicador) para o badge de status.
 */
...
/**
 * Calcula a porcentagem de conclusao de uma lista de tarefas.
 */
