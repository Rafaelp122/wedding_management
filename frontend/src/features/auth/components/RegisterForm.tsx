      ...
      <Form {...form}>
        ...
        >
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <input
                    type="text"
                    className="block w-full px-3.5 py-2 text-xs border border-zinc-200 dark:border-zinc-855 bg-zinc-50 dark:bg-zinc-900 rounded-xl text-zinc-955 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-aura-500/30 focus:border-aura-500 transition-all font-medium"
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full mt-2 flex items-center justify-center gap-2 bg-aura-600 hover:bg-aura-700 text-white font-bold py-3 px-4 rounded-xl text-xs uppercase tracking-wider transition-all duration-250 shadow-lg shadow-aura-500/20 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isPending ? (
              <>
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        className="flex items-center justify-center gap-2 py-2 px-4 border border-zinc-200 dark:border-zinc-800 rounded-xl text-xs font-semibold hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors bg-transparent"
      >
