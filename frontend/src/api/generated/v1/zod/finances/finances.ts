...
export const FinancesExpensesCreateBody = zod.object({
  ...
  "num_installments": zod.union([zod.int().min(financesExpensesCreateBodyNumInstallmentsOneMin),zod.null()]).optional(),
...
export const FinancesExpensesUpdateBody = zod.object({
  ...
  "num_installments": zod.union([zod.int().min(financesExpensesUpdateBodyNumInstallmentsOneMin),zod.null()]).optional(),
  "first_due_date": zod.union([zod.iso.date(),zod.null()]).optional()
})
