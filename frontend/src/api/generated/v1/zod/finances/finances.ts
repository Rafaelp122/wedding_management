 ...
 */
export const FinancesBudgetsForEventParams = zod.object({
  event_uuid: zod.string(),
});

export const financesBudgetsForEventResponseTotalEstimatedRegExp = new RegExp(
  "^(?!^[-+.]\*$)[+-]?0\*\\d\*\\.?\\d\*$",
);
export const financesBudgetsForEventResponseTotalOverallSpentDefault = `0.00`;
export const financesBudgetsForEventResponseTotalOverallSpentRegExp =
  new RegExp("^(?!^[-+.]\*$)[+-]?0\*\\d\*\\.?\\d\*$");

export const FinancesBudgetsForEventResponse = zod.object({
  uuid: zod.string(),
  event: zod.string(),
  total_estimated: zod
    .string()
    .regex(financesBudgetsForEventResponseTotalEstimatedRegExp),
  total_overall_spent: zod
    .string()
    .regex(financesBudgetsForEventResponseTotalOverallSpentRegExp)
    .default(financesBudgetsForEventResponseTotalOverallSpentDefault),
  notes: zod.union([zod.string(), zod.null()]).optional(),
});
