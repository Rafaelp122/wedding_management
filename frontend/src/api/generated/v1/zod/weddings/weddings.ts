...
export const WeddingsCreateBody = zod.object({
  ...
  "date": zod.iso.date(),
  "location": zod.string(),
  "expected_guests": zod.union([zod.int(),zod.null()]).optional(),
...
export const WeddingsOverviewReadResponse = zod.object({
  ...
  "overdue_installments": zod.int().min(weddingsOverviewReadResponseWeddingOverdueInstallmentsMin).default(weddingsOverviewReadResponseWeddingOverdueInstallmentsDefault),
  "incomplete_tasks": zod.int().min(weddingsOverviewReadResponseWeddingIncompleteTasksMin).default(weddingsOverviewReadResponseWeddingIncompleteTasksDefault)
}),
  "overview": zod.object({
