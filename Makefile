...
help:
	...
	@echo "  make frontend-dev        - 🔥 Vite dev server local (fora do Docker)"
	...
	@echo "  make check-frontend      - ✅ Lint + type-check + testes + build prod (CI gate)"
	@echo "  make check-frontend-dev  - ✅ Lint + type-check + testes (sem build, mais rápido)"
	...
	@echo "=========================================================================="
	@echo "⚠️  Nota: make build ≠ npm run build. make build reconstrói containers"
	@echo "   Docker (modo dev). npm run build compila o frontend para produção."
