...
- **Dumb Components**: Devem ser puramente visuais, recebendo callbacks e dados via Props. Devem ser síncronos e sem side-effects de rede ou navegação, facilitando testes unitários rápidos.
