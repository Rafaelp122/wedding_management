...
- [ ] **BR-F03 / BR-F05 / BR-F11 (Payment & Overdue Transitions)**: Installment marked `PAID` requires `paid_date`. Unmarking clears `paid_date` and reverts to `PENDING` or `OVERDUE`. → [financial-integrity-rules.md](../../../docs/4-explanation/business-rules/finances/financial-integrity-rules.md)
...
- [ ] **BR-F07 / BR-F10 (Mandatory 1 Installment & Expense Name)**: Expenses auto-generate at least 1 installment and require a mandatory `name`. → [financial-integrity-rules.md](../../../docs/4-explanation/business-rules/finances/financial-integrity-rules.md)
...
- [ ] **BR-L03 / BR-L04 (Supplier Sharing & Acquisition Decoupling)**: Suppliers reusable across planner weddings; item delivery independent of payment. → [contract-state-machine.md](../../../docs/4-explanation/business-rules/logistics/contract-state-machine.md)
