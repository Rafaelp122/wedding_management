...
- [ ] **Execution & Standards Reference**:
  ...
  - Documentação de referência: [Frontend Testing Spec](../../../docs/reference/testing/frontend-testing-spec.md) | [E2E Testing Spec](../../../docs/reference/testing/e2e-testing-spec.md) | [MSW Patterns](../../../docs/guides/frontend/msw-testing-patterns.md)
