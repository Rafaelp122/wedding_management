...
class ContractQuerySetTest(TestCase):
    ...
    def setUp(self):
        # Cria planners
        self.planner1 = User.objects.create_user(
            'planner1', 'p1@test.com', '123'
        )
        self.planner2 = User.objects.create_user(
            'planner2', 'p2@test.com', '123'
        )
    ...
    def test_bulk_cancel_updates_status(self):
        ...
        canceled = Contract.objects.filter(
            item__wedding__planner=self.planner1,
            status='CANCELED'
        )
    ...
    def test_bulk_update_description_updates_all(self):
        ...
        count = (
            Contract.objects
            .editable()
            .bulk_update_description(new_description)
        )
